      ...
      <div className="border-b border-gray-200 p-4">
        <div className="flex items-center justify-between gap-4 max-w-6xl mx-auto">
          <div className="flex-1">
            <h1 className="text-2xl font-semibold text-gray-900 mb-2">Search LEIA</h1>
            <SearchFilter
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="max-w-6xl mx-auto p-6">
          ...
          {loading ? (
            ...
            <div className="py-16 text-center text-gray-500">No LEIAs found</div>
          ) : (
            <ul className="divide-y divide-gray-200 bg-white rounded-md border border-gray-200">
              {leias.map((leia) => {
                const description =
                  ...
                  "";
                return (
                  <li key={leia.id} className="flex items-start justify-between gap-4 p-4">
